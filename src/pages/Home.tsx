        ...
        <Layout>
            ...
            <div className='flex justify-center px-10 py-20 text-white bg-primary'>
                <div className='flex flex-col gap-6 items-center w-fit max-w-5xl'>
                    <div className='text-2xl desktop:text-3xl font-bold flex items-center gap-2'><div className='text-3xl desktop:text-4xl font-black'>33%</div> OF ALL FOOD PRODUCED WORLDWIDE IS WASTE</div>
